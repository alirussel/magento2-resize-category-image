...
class Resizer extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function resizeImage($img, $width = 780, $height = 505)
    {
        ...
        try {
            ...
            $targetDir = $mediaDir->getAbsolutePath('ali/cache/' . $width . 'x' . $height);
            ...
            if ($this->_directory->isFile($this->_directory->getRelativePath($dest))) {
                return $this->storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'ali/cache/' . $width . 'x' . $height . '/' . $imageName;
            }
        } catch (\Exception $e) {
